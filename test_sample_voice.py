"""
Test the sample voice file with detailed analysis
"""
...
def test_sample_voice():
    """Test the sample voice 1.mp3 file"""
    
    audio_file = Path("sample voice 1.mp3")
    ...
    print("\n" + "="*80)
    print("TESTING: sample voice 1.mp3")
    print("="*80)
